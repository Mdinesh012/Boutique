...
def order_add():
    ...
    if request.method == "POST":
        ...
        stitching_charge = parse_float(request.form.get("stitching_charge"), 0.0)
        lining_charge = parse_float(request.form.get("lining_charge"), 0.0)
        total_amount = parse_float(request.form.get("total_amount"), 0.0)
        if not total_amount:
            total_amount = stitching_charge + lining_charge
        ...
        measurement = OrderMeasurement(
            ...
            upper_chest=parse_float(request.form.get("upper_chest"), None) or None,
            under_bust=parse_float(request.form.get("under_bust"), None) or None,
            waist=parse_float(request.form.get("waist"), None) or None,
            waist_length=parse_float(request.form.get("waist_length"), None) or None,
            natural_waist=parse_float(request.form.get("natural_waist"), None) or None,
            hip=parse_float(request.form.get("hip"), None) or None,
            waist_to_knee=parse_float(request.form.get("waist_to_knee"), None) or None,
            waist_to_ankle=parse_float(request.form.get("waist_to_ankle"), None) or None,
            waist_to_calf=parse_float(request.form.get("waist_to_calf"), None) or None,
            length=parse_float(request.form.get("length"), None) or None,
            kurti_length=parse_float(request.form.get("kurti_length"), None) or None,
            pant_length=parse_float(request.form.get("pant_length"), None) or None,
            leg_round=parse_float(request.form.get("leg_round"), None) or None,
            sleeve_length=parse_float(request.form.get("sleeve_length"), None) or None,
            sleeve_round=parse_float(request.form.get("sleeve_round"), None) or None,
            front_neck=parse_float(request.form.get("front_neck"), None) or None,
            back_neck=parse_float(request.form.get("back_neck"), None) or None,
...
def order_edit(order_id):
    ...
    if request.method == "POST":
        ...
        order.stitching_charge = parse_float(request.form.get("stitching_charge"), order.stitching_charge)
        order.lining_charge = parse_float(request.form.get("lining_charge"), order.lining_charge)
        total_amount = parse_float(request.form.get("total_amount"), None)
        if total_amount:
            order.total_amount = total_amount
        else:
            order.total_amount = order.stitching_charge + order.lining_charge
        ...
        m.upper_chest = parse_float(request.form.get("upper_chest"), None) or None
        m.under_bust = parse_float(request.form.get("under_bust"), None) or None
        m.waist = parse_float(request.form.get("waist"), None) or None
        m.waist_length = parse_float(request.form.get("waist_length"), None) or None
        m.natural_waist = parse_float(request.form.get("natural_waist"), None) or None
        m.hip = parse_float(request.form.get("hip"), None) or None
        m.waist_to_knee = parse_float(request.form.get("waist_to_knee"), None) or None
        m.waist_to_ankle = parse_float(request.form.get("waist_to_ankle"), None) or None
        m.waist_to_calf = parse_float(request.form.get("waist_to_calf"), None) or None
        m.length = parse_float(request.form.get("length"), None) or None
        m.kurti_length = parse_float(request.form.get("kurti_length"), None) or None
        m.pant_length = parse_float(request.form.get("pant_length"), None) or None
        m.leg_round = parse_float(request.form.get("leg_round"), None) or None
        m.sleeve_length = parse_float(request.form.get("sleeve_length"), None) or None
        m.sleeve_round = parse_float(request.form.get("sleeve_round"), None) or None
        m.front_neck = parse_float(request.form.get("front_neck"), None) or None
        m.back_neck = parse_float(request.form.get("back_neck"), None) or None
